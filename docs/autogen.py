...
def class_to_source_link(cls):
    ...
    link = ('https://github.com/TimLucaTuran/'
            'stacker/tree/master/' + path + '#L' + str(line))
    return '[[source]](' + link + ')'
...
def generate(sources_dir):
    ...
    """
    template_dir = os.path.join(str(main_dir), 'docs', 'templates')
    ...
    readme = read_file(os.path.join(str(main_dir), 'README.md'))
...
if __name__ == '__main__':
    generate(os.path.join(str(main_dir), 'docs', 'sources'))
